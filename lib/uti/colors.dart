...
class AppColors {
  ...
  static final Color green1Color = const Color(0xFF138808);
  static final Color green2Color = const Color(0xFF005C29);
  static final Color green3Color = const Color(0xFF32CD32);
}
